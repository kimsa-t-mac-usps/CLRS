...
<!---
3/27/08 Status Code 4 added as workaround for CILO cases not previously entered in this system, where below reporting threshold
--->
...
<!--- Had been moved to application.cfm: --->
<!---
<link Rptfullcfm at 46 rel="stylesheet" type="text/css" href="stylesheet.css">
--->
...
<!---<CFOUTPUT>
<p>
In Report.Full.cfm at 64: 
<br>
FormRecID = #IsDefined("Form.RecID")#
<!---#Form.RecID#--->
<!---RecIDParm = #RecIDParm#--->
<br>
EarlierRptDate = #IsDefined("EarlierRptDate")#
<p>
</cfoutput>--->
