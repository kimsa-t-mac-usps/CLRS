...
<!------------- cfloop.cur_rem_Casetype.AssessCutoff.Query.Error.cfm --------->
<!---------------------------------------------------------------------------->
<!--- KS1 --->
	<!---<CFOUTPUT>
		Program = "cfloop.cur_rem_Casetype.AssessCutoff.Query.Error.cfm at 4"
	</CFOUTPUT>--->
		...
		<CFIF Skip_Assess_Cutoff_List EQ "no">
			...
			<CFLOOP INDEX="Assess_Cutoff_List_Index" LIST="#Assess_Cutoff_List#">
				...
				<CFIF Current_Removed_List_Index EQ "New">
					...
					<CFIF Assess_Cutoff_List_Index EQ "NewTenMillionAndAbove">
