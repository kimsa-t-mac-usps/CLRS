...
--->
<!---<CFOUtput>
	THIS NEW LIST FROM TEXTCOMPARE.CFM LINE 44 -- #ThisNewList# end--
</cfoutput>--->
...
--->
<!---<CFOUtput>
	THIS OLD LIST FROM TEXTCOMPARE.CFM LINE 102 -- #ThisOldList# end--
</cfoutput>--->
...
--->
			...
			NewArrayLen EQ 1
				...
				<CFSET ThisNewList = "<span>" & ThisNewList & "</span>">
...
<!--- Close <CFIF NewArrayLen LT OldArrayLen>: --->
			...
			Form.CorpFinFormatFrontOffcVersion EQ "CorpFinFormatFrontOffcVersion"
				...
				<CFSET ThisNewList = RedBoldToggleSpan & ThisNewList & "</strong>">
...
<!--- From <CFIF Compare(ThisOldList, ThisNewList) NEQ 0> --->
		<CFELSE>
			...
			Form.CorpFinFormatFrontOffcVersion EQ "CorpFinFormatFrontOffcVersion"
				...
				<CFSET ThisOldList = RedBoldToggleSpan & ThisOldList & "</strong>">
