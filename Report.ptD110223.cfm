...
Defined in Report.ptA:

CLRC_Query_Name = "CONTINGENT_LIAB_GetRecord_Current" & "_" & Current_Removed_List_Index & "_" & Case_Type_List_Index & "_" & Assess_Cutoff_List_Index
...
<CFIF DateCompare(ThisReportDate, NewCLProtocolReportDate) GE 0>
	...
	<CFELSE>
		...
		<!---
		<CFOUTPUT>
		[Unspecified; STATUS_CODE = #STATUS_CODE#]
		</CFOUTPUT>
		--->
