...
<CFELSE>
	...
	<CFQUERY NAME="EeList_COUNSEL_LAW_DEPT" DATASOURCE="lddb">
	...
	<CFIF STATUS_CODE EQ 1 OR STATUS_CODE_SELECTED EQ "1">
		...
		<CFIF ThisReportDate NEQ EarliestReportDate AND PrevReportDate NEQ "">
			...
			<CFIF Prev_ThisCOUNSEL_LAW_DEPT NEQ "" AND Prev_ThisCOUNSEL_LAW_DEPT NEQ 0>
				...
				<CFQUERY NAME="Prev_EeList_COUNSEL_LAW_DEPT" DATASOURCE="lddb">
...
<CFIF COCOUNSEL_LAW_DEPT NEQ "" AND COCOUNSEL_LAW_DEPT NEQ 0>
	...
	<CFQUERY NAME="EeList_COCOUNSEL_LAW_DEPT" DATASOURCE="lddb">
	SELECT LASTNAME, FIRSTNAME
	FROM lawdepartment
	...
	STATUS_CODE_SELECTED EQ "1">
		...
		PrevReportDate NEQ "">
			...
			Prev_ThisCOCOUNSEL_LAW_DEPT NEQ 0>
				...
				<CFQUERY NAME="Prev_EeList_COCOUNSEL_LAW_DEPT" DATASOURCE="lddb">
				SELECT LASTNAME, FIRSTNAME
				FROM lawdepartment
...
<CFELSE>
	...
	<CFQUERY NAME="LDOffices_LAW_DEPT_OFFICE" DATASOURCE="lddb">
	SELECT OFFICE
	FROM ldoffices
	WHERE
	...
	STATUS_CODE_SELECTED EQ "1">
		...
		PrevReportDate NEQ "">
			...
			Prev_ThisLAW_DEPT_OFFICE NEQ 0>
				...
				<CFQUERY NAME="Prev_LDOffices_LAW_DEPT_OFFICE" DATASOURCE="lddb">
				SELECT OFFICE
				FROM ldoffices
				WHERE
...
ALT_LAW_DEPT_OFFICE NEQ 0>
	...
	<CFQUERY NAME="LDOffices_ALT_LAW_DEPT_OFFICE" DATASOURCE="lddb">
	SELECT OFFICE
	FROM ldoffices
	WHERE
	...
	STATUS_CODE_SELECTED EQ "1">
		...
		PrevReportDate NEQ "">
			...
			Prev_ThisALT_LAW_DEPT_OFFICE NEQ 0>
				...
				<CFQUERY NAME="Prev_LDOffices_ALT_LAW_DEPT_OFFICE" DATASOURCE="lddb">
				SELECT OFFICE
				FROM ldoffices
				WHERE
