...
<CFIF NOT (IsDefined("Form.CorpFinFormat") AND Form.CorpFinFormat EQ "CorpFinFormat")>
	...
	<CFELSE>
		...
		<!---12/24/2024 ?? CFSET This_DIVISION_NAME = This_DIVISION_CODE---><CFSET This_DIVISION_NAME = "">
	...
	ListFind(ValueList(Get_Districts.NAME), This_DIST_PERF_CLUSTER_NAME) EQ 0>
		...
		<!---KS 12.26.2024 <strong>[Select New District]&nbsp;<span class='ClickEdit'>Click "Edit This Case Record" to select</span></strong>--->
