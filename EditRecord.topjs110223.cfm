...
/*
alert("At checkupdFactsFlagArray");
*/
...
/*
alert("thisForm.FIELD_GRIEVANCE_FLAG.options[thisForm.FIELD_GRIEVANCE_FLAG.selectedIndex].value = '" + thisForm.FIELD_GRIEVANCE_FLAG.options[thisForm.FIELD_GRIEVANCE_FLAG.selectedIndex].value + "'");
*/



// alert("thisForm.COMMENT_GENERAL.value.length = " + thisForm.COMMENT_GENERAL.value.length);

<!---
<CFOUTPUT>
var Comment_Gen_Char_Limit = #Comment_Gen_Char_Limit#;
</cfoutput>


if (thisForm.COMMENT_GENERAL.value.length > Comment_Gen_Char_Limit) {

	alert("The text in the Comment / Notes box is too long. Please make it shorter than the " + Comment_Gen_Char_Limit + " character limit.");
...
// alert("Before checkupdFactsFlagArray_returnFalseFlag = ");
...
/*
alert("After checkDateFiledAmtConflict(): returnFalseFlag = " + returnFalseFlag);
*/


/*
alert("After checkDateFiledAmtConflict(): checkupdFactsFlagArray_returnFalseFlag = " + checkupdFactsFlagArray_returnFalseFlag);
*/
