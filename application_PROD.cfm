...
<!--- Highlighting turn off ended 12/7/21:
...
<!--- commented out after user 336 is no longer the admmin
...
<CFSET LDAPDistingName = "CN=Jung\, Uk J - DD32J0,OU=Users,OU=HQ,OU=HQ,OU=Users & Workstations,DC=usa,DC=dce,DC=usps,DC=gov">
--->
<CFSET LDAPDistingName = "CN=LDIS,OU=Users,OU=HQ,OU=HQ,OU=Users & Workstations," & startstr>
...
<!---
    dn="#LDAPDistingName#"
--->
<!--- 03/08/2022-- testing bc it keeps on failing
	Replaced this with the filter attribute below in cfldap
