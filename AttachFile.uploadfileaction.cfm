...
<CFIF NOT DirectoryExists(CFFILE_Destination_Dir)>

	<cfdirectory action = "create" directory = "#CFFILE_Destination_Dir#">
...
Form.FileReplace EQ "yes">
	...
	<CFSET FileToDelete = CFFILE_Destination_Dir & "CL.Case." & Form.CaseRecIDSeq & ".GC.xls">
...
<CFIF IsDefined("Form.CaseRecIDSeq")>
	<CFOUTPUT>
	ReturnForm.action = "AttachFile.cfm?CaseRecIDSeq=#Form.CaseRecIDSeq#&RecIDParm=#Form.RecID#";
	</cfoutput>
<CFELSE>
	ReturnForm.action = "AttachFile.cfm";
</cfif>
