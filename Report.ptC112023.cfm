...
<CFIF NOT (IsDefined("Form.CorpFinFormat") AND Form.CorpFinFormat EQ "CorpFinFormat")>
	<cfoutput>
	<tr valign="top" style="line-height:80%">
		<th align="right" >
			District
		</th>
		<cfinvoke component="components/textFormat" method="checkDivDistArea" returnvariable="cellStyle">
				<cfinvokeargument name="newName" value="#get_single_record.dist_perf_cluster_name#">
				<cfinvokeargument name="oldName" value="#CONTINGENT_LIAB_GetRecord_PrevRpt.dist_perf_cluster_name#">
			</cfinvoke>
			<!--- <cfdump var="#cellStyle#" abort="true"> --->
		<td style="#cellStyle#" >
			<cfif isdefined("DIST_PERF_CLUSTER_NAME") AND len(DIST_PERF_CLUSTER_NAME) GT 0>
	...
	<tr valign="top" style="line-height:80%">
		...
		<cfinvoke component="components/textFormat" method="checkDivDistArea" returnvariable="cellStyle">
			<cfinvokeargument name="newName" value="#get_single_record.division_code#">
			<cfinvokeargument name="oldName" value="#CONTINGENT_LIAB_GetRecord_PrevRpt.division_code#">
		</cfinvoke>
		<td style="#cellStyle#">
			<cfif isdefined("DIVISION_CODE") AND len(DIVISION_CODE) GT 0>
				#DIVISION_CODE#
			<cfelse>
				&nbsp;
			</cfif>
	...
	<tr valign="top" style="line-height:80%">
		...
		<cfinvoke component="components/textFormat" method="checkDivDistArea" returnvariable="cellStyle">
			<cfinvokeargument name="newName" value="#get_single_record.AREA_NAME#">
			<cfinvokeargument name="oldName" value="#CONTINGENT_LIAB_GetRecord_PrevRpt.AREA_NAME#">
		</cfinvoke>
		<td style="#cellStyle#" >
			<cfif isdefined("AREA_NAME") AND len(AREA_NAME) GT 0>
				#AREA_NAME#
			<cfelse>
				&nbsp;
			</cfif>
