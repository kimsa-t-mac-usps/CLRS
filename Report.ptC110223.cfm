...
<!---
	<CFOUTPUT>
    <p>
    Report.ptC.cfm at 345:<br />

	This_DIST_PERF_CLUSTER_NAME = "#This_DIST_PERF_CLUSTER_NAME#"
    <br />
...
Report.ptC.cfm at 382:
<br />

This_DIVISION_NAME = "#This_DIVISION_NAME#"
<p>
</CFOUTPUT>
--->
...
<!---
	<CFOUTPUT>
    <p>
    ListFind(ValueList(Get_Districts.NAME), This_DIST_PERF_CLUSTER_NAME) = #ListFind(ValueList(Get_Districts.NAME), This_DIST_PERF_CLUSTER_NAME)#
    <p>
    </CFOUTPUT>
--->
...
<!---
	<CFIF ListFind(ValueList(Get_Districts.NAME), This_DIST_PERF_CLUSTER_NAME) EQ 0
	AND
	This_AREA_NAME EQ "">
--->
			...
			<CFIF ThisReportDate NEQ EarliestReportDate AND PrevReportDate NEQ "">
				...
				<CFELSE>
                	...
                	<CFIF CONTINGENT_LIAB_GetRecord_PrevRpt.DIST_PERF_CLUSTER_NAME DOES NOT CONTAIN "District">
						<CFSET OldList = CONTINGENT_LIAB_GetRecord_PrevRpt.DIST_PERF_CLUSTER_NAME & " District">
    				<CFELSE>
						<CFSET OldList = CONTINGENT_LIAB_GetRecord_PrevRpt.DIST_PERF_CLUSTER_NAME>
                	</CFIF>
...
<!---                
				<CFIF CONTINGENT_LIAB_GetRecord_PrevRpt.AREA_NAME NEQ "">
					<CFSET OldList = OldList & " (" & CONTINGENT_LIAB_GetRecord_PrevRpt.AREA_NAME & ")">
				</cfif>
--->                
                

				<CFIF This_AREA_NAME NEQ "">
    	            <CFSET OldList = OldList & " (" & This_AREA_NAME & ")">
                </CFIF>
...
<!---    
			<CFIF ThisReportDate NEQ EarliestReportDate AND PrevReportDate NEQ "">
				<CFSET OldList = CONTINGENT_LIAB_GetRecord_PrevRpt.AREA_NAME>
			</cfif>
--->
...
<!---
	...
	AND
	CONTINGENT_LIAB_GetRecord_PrevRpt.DIST_PERF_CLUSTER_NAME NEQ This_DIST_PERF_CLUSTER_NAME
...
<!---	
	<CFIF NOT IsDefined("EarlierRptDate") AND NOT (IsDefined("ALT_LAW_DEPT_OFFICE_Flag") AND ALT_LAW_DEPT_OFFICE_Flag EQ "yes")>
		...
		<CFSET NewList = '<span style="color:red; font-weight:bold">Report.ptC at 537 [None Selected]</span>&nbsp;<span class="ClickEdit">Click "Edit This Case Record" to select</span>'>
...
<!---
	...
	Report.ptC.cfm at 751:
    <br />

	This_DIVISION_NAME = "#This_DIVISION_NAME#"
    <br />
	
	CONTINGENT_LIAB_GetRecord_PrevRpt.DIVISION_NAME = "#CONTINGENT_LIAB_GetRecord_PrevRpt.DIVISION_NAME#"
	<p>
...
<!---    
	<CFIF NOT
	(
	This_DIST_PERF_CLUSTER_NAME NEQ ""
	OR
	This_AREA_NAME NEQ ""
	OR
	This_DIVISION_NAME NEQ ""
	)>
--->
