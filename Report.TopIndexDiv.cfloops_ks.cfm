	...
	<br>
				...
				<!---KS --->	
				 <!---<cfoutput>
				 	<br />
				 	<br />
				 	Program = "Report.TopIndexDiv.cfloops.cfm at 194"
				 	<br />
				 	CLRC_Query_Name = #CLRC_Query_Name#
				 	<br />
				 	Query_RecordCount = #Query_RecordCount#
				 	<br />
				 	<!---This_RecordCount = #Evaluate(Query_RecordCount)#--->
				 	<br />
				 </cfoutput>--->
	...
	<!---KS2xxxxxx --->
					<!---<CFIF (Current_Removed_List_Index EQ "Removed"
							and Assess_Cutoff_List_Index EQ "UnderTenMillion"
								and Skip_CLRC_Query EQ "no")>
							<CFSET	This_RecordCount = 0>
						<cfelse> 	
					...
					<<!---CFIF (Current_Removed_List_Index EQ "Removed"
							and Assess_Cutoff_List_Index EQ "UnderTenMillion"
								and Skip_CLRC_Query EQ "no")>
							<CFSET	CLRC_Query_Name = 'MainReport_CONTINGENT_LIAB_GetRecord_Current_Removed_Liabilities_TenMillionAndAbove'>
							<CFSET Query_RecordCount = CLRC_Query_Name & ".RecordCount">
							<CFSET This_RecordCount = Evaluate(Query_RecordCount)> 
						<cfelse> 	
							<CFSET This_RecordCount = Evaluate(Query_RecordCount)> 
				...
				<!---<cfoutput>
				 	<br />
				 	<br />
				 	Program = "Report.TopIndexDiv.cfloops.cfm at 221"
				 	<br />
				 	CLRC_Query_Name = #CLRC_Query_Name#
				 	<br />
				 	Query_RecordCount = #Query_RecordCount#
				...
				<!---<cfoutput>
				 	<br />
				 	<br />
				 	Program = "Report.TopIndexDiv.cfloops.cfm at 241"
				 	<br />
				 	Current_Removed_List_Index = #Current_Removed_List_Index#
				 	<br />
				 	CLRC_Query_Name   = #CLRC_Query_Name#
				 	...
				 	Query_RecordCount = #Query_RecordCount#
				 	<br />
				 	Query_CurrentRow  = #Query_CurrentRow#
				 	<br />
				 </cfoutput>--->
...
<!---KS2 --->
	<!---<CFOUTPUT>
	<br>	
	In report.topindexdiv.cfloops.cfm at 261: -- KS2
	<br>	
	Case_Type_List_Index = #Case_Type_List_Index#
	<br>
	CLRC_Query_Name = #CLRC_Query_Name#
	...
	Skip_CLRC_Query = #Skip_CLRC_Query#
	 ...
	 This_RecordCount = #This_RecordCount#
	<br>
	</CFOUTPUT>--->
...
<!---<CFOUTPUT>
<p>
In Report.TopIndexDiv.cfloops.cfm at 109:
<br />
Skip_CLRC_Query = #Skip_CLRC_Query#
<br />
...
<p></p>
				...
				<!---<cfoutput>
				 	<br />
				 	<br />
				 	Program = "Report.TopIndexDiv.cfloops.cfm at 322"
				 	<br />
				 	Program = ""sectionheadings.cfset.cfm"
				 	<br />
				 	CLRC_Query_Name = #CLRC_Query_Name#
				 	<br />
				 	This_RecordCount = #This_RecordCount#
