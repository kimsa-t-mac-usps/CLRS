...
--->
						...
						<CFSET NewStartCrxVal = "<span>" & ListGetAt(ThisNewList, StartCrx, " ")>
...
--->
						...
						<CFSET NewEndCrxVal = ListGetAt(ThisNewList, EndCrx, " ") & "</span>">
...
--->
					...
					<CFIF ListLen(ThisNewList, " ") GT (ListLen(ThisOldList, " ") + NewListExtraLength)>
						...
						<CFSET NewStartCrxVal = "<span>" & ListGetAt(ThisNewList, NewStartCrxPos, " ")>
...
--->
						...
						<CFSET ThisNewList = ThisNewList & "</span>">
