...
<!---
Status_Code_Var from STATUS_CODE or CONTINGENT_LIAB_GetRecord_PrevRpt.STATUS_CODE
...
<CFCASE VALUE="4">
<!---
	<CFSET Status_Code_Label = "Updated This Quarter">
--->
<!---
...
<!---
	<CFSET Status_Code_Label = 'Change in Damages Assessment or Amount Sought '>
	<CFSET Status_Code_Label = Status_Code_Label & '<span id="StillMeetsThresholdNote">(Still Meets Threshold)</span>'>
--->
...
<CFCASE VALUE="8">
<!---
	<CFSET Status_Code_Label = "Additional Facts">
--->
...
<CFCASE VALUE="9">
<!---
	<CFSET Status_Code_Label = "Revised Most Likely Payout">
--->
